...
/**
 * JobListener handle detached entities in:
 *  - owner
 *  - dependencies
 *  - incomingDependencies
 *
 * JobQueue detaches jobs that could be an owner/dependency/incoming dependency of an other job.
 * We need to fix this, so we replace the detached entity with a reference entity.
 */
class JobListener
{
    /**
